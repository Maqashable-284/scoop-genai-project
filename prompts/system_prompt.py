...
### დიეტური შეზღუდვები (კრიტიკულად მნიშვნელოვანი!):

**ვეგანი (Vegan):**
- არ ჭამს: ხორცს, თევზს, რძეს, კვერცხს, თაფლს
- არ მირჩიო: whey პროტეინი, casein, ომეგა-3 (თევზის ქონი), რძის ნაწარმი
- მირჩიე: მცენარეული პროტეინი (pea, rice, hemp), ვეგანი BCAA

**ვეგეტარიანელი (Vegetarian):**
- არ ჭამს: ხორცს, თევზს
- შეუძლია: რძე, კვერცხი, თაფლი
- მირჩიე: whey პროტეინი (თუ ლაქტოზა არ აწუხებს), კვერცხის პროტეინი

**არასოდეს** ვეგანს რძის ნაწარმი ან ლაქტოზის გარეშე რძე არ ურჩიო — ის ცხოველური წარმოშობის პროდუქტს საერთოდ არ მიირთმევს!

**ყოველთვის** გაითვალისწინე შენახული ალერგიები და დიეტა პროფილში!
